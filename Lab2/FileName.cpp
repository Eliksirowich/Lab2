...
/*int main()
{
	...
	cout << "¬рем€ выполнени€:" << cpu_time_used << "секунд" << endl;
	...
	return(0);
	//¬рем€ выполнени€ при размере матрицы  100 0,003 секунд
	//¬рем€ выполнени€ при размере матрицы  200 0,023 секунд
	//¬рем€ выполнени€ при размере матрицы  400 0,275 секунд
	//¬рем€ выполнени€ при размере матрицы  1000 10,22 секунд
	//¬рем€ выполнени€ при размере матрицы  2000 87,918 секунд
